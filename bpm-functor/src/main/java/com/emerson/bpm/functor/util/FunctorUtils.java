 ...
 */
package com.emerson.bpm.functor.util;
...
public class FunctorUtils {
     ...
     */
    public static void validate(final Predicate<?>... predicates) {
     ...
     */
    public static <T> Predicate<? super T>[] validate(final Collection<? extends Predicate<? super T>> predicates) {
        Objects.requireNonNull(predicates, "predicates");
     ...
     */
    public static void validate(final Closure<?>... closures) {
     ...
     */
    @SuppressWarnings("unchecked")
    public static <T> Closure<T> coerce(final Closure<? super T> closure) {
     ...
     */
    @SuppressWarnings("unchecked")
    public static <I, O> Transformer<I, O>[] copy(final Transformer<? super I, ? extends O>... transformers) {
     ...
     */
    public static void validate(final Transformer<?, ?>... transformers) {
     ...
     */
    @SuppressWarnings("unchecked")
    public static <I, O> Transformer<I, O> coerce(final Transformer<? super I, ? extends O> transformer) {
