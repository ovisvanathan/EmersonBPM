...
import com.emerson.bpm.nodes.match.el.api.MethodExpressionImpl;
import com.emerson.bpm.nodes.match.el.api.MethodExpressionLiteral;
import com.emerson.bpm.nodes.match.el.api.ValueExpressionImpl;
 ...
 * @author Omprakash Viswanathan // EL cache
...
public final class ExpressionBuilder implements NodeVisitor {
    ...
    public ExpressionBuilder(String expression, ELContext ctx)
        ...
        this.fnMapper = ctx.getFunctionMapper();
    ...
    private final static Node createNodeInternal(String expr)
            throws ELException {
        if (expr == null) {
            throw new ELException("error.null");
        }
        ...
        if (n == null) {
            try {
                ...
                throw new ELException("Error Parsing: " + expr + " <ParseException>" + pe.getMessage());
            }
        }
        return n;
    }
    ...
    public Node build() throws ELException {
