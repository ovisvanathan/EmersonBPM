...
import static com.emerson.bpm.rule.parser.factory.DRLFactory.buildLexer;
import static com.emerson.bpm.rule.parser.factory.DRLFactory.buildParser;
...
public class DrlParser {
    ...
    public PackageDescr parse(final boolean isEditor,
        ...
        IDRLParser parser = buildParser(lexer, languageLevel);
    ...
    private PackageDescr compile(boolean isEditor,
                                  final IDRLParser parser ) throws DroolsParserException {
    ...
    private void makeErrorList( final IDRLParser parser ) {
