...
package com.emerson.bpm.rule.parser.factory;
...
import com.emerson.bpm.rule.parser.DRL5Expressions;
import com.emerson.bpm.rule.parser.DRL5Lexer;
import com.emerson.bpm.rule.parser.DRL5Parser;
...
import com.emerson.bpm.rule.parser.DRL6StrictParser;
import com.emerson.bpm.rule.parser.DRLExpressions;
import com.emerson.bpm.rule.parser.DRLLexer;
import com.emerson.bpm.rule.parser.IDRLParser;
import com.emerson.bpm.rule.parser.ParserHelper;
...
public class DRLFactory {
    ...
    public static IDRLParser buildParser(String text, LanguageLevelOption languageLevel) {
        return buildParser(new ANTLRStringStream(text), languageLevel);
    }

    public static IDRLParser buildParser( Reader reader, LanguageLevelOption languageLevel ) {
        try {
    ...
    public static IDRLParser buildParser( final InputStream is, final String encoding, LanguageLevelOption languageLevel ) {
        try {
