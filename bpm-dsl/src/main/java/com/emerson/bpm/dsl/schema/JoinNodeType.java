 ...
 *         &lt;element name="comparator" type="{http://www.example.org/RulkesDSLSchema}JoinComparatorType"/&gt;
 *         &lt;choice&gt;
 ...
 *           &lt;element name="ruleNode" type="{http://www.example.org/RulkesDSLSchema}RTMNodeType"/&gt;
 *         &lt;/choice&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
...
public class JoinNodeType {
    ...
    @XmlElement(required = true)
    protected JoinComparatorType comparator;
    protected AlphaNodeType alphaNode;
    protected JoinNodeType joinNode;
    protected RTMNodeType ruleNode;
     ...
     * @return
     *     possible object is
     *     {@link JoinComparatorType }
     *     
     */
    public JoinComparatorType getComparator() {
        return comparator;
    }
     ...
     *     
     */
    public void setComparator(JoinComparatorType value) {
    ...
    /**
     * Gets the value of the ruleNode property.
     * 
     * @return
     *     possible object is
     *     {@link RTMNodeType }
     *     
     */
    public RTMNodeType getRuleNode() {
        return ruleNode;
    }

    /**
     * Sets the value of the ruleNode property.
     * 
     * @param value
     *     allowed object is
     *     {@link RTMNodeType }
     *     
     */
    public void setRuleNode(RTMNodeType value) {
        this.ruleNode = value;
    }
